...
class StudentTestCase(LiveServerTestCase):
    ...
    def test_student_find_solos(self):
        ...
        instrument_input = self.browser.\
            find_element_by_css_selector('input#jmad-instrument')
        ...
        self.assertEqual(
            ...
            '/recordings/kind-of-blue/all-blues/cannonballadderley/'
        )

        # he sees the artist...
        self.assertEqual(self.browser.\
            find_element_by_css_selector('#jmad-artist').text,
            'Cannonball Adderley'
        )
        ...
        self.assertEqual(self.browser.\
            find_element_by_css_selector('#jmad-album').text,
